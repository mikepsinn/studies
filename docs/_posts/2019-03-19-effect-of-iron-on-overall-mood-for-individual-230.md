...
<td align="center" bgcolor="#2b3138" style="background-color: #2b3138; margin: auto; max-width: 600px; -webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; padding: 15px 20px; " width="100%">
            ...
            <div style="text-align: center">
                <img src="https://d2u41rntmognc9.cloudfront.net/charts/460/iron/iron-over-time-smoothed-chart.svg" alt="This chart shows how your Iron changes over time." title="Iron Over Time (Smoothed)">
</div>
            <div style="text-align: center">
...
<div class="study-section-body" style='--x-height-multiplier: 0.375; --baseline-multiplier: 0.17; font-family: medium-content-serif-font, Georgia, Cambria, "Times New Roman", Times, serif; letter-spacing: -.003em; font-weight: 400; font-style: normal; font-size: 21px; line-height: 1.58;'>This individual's Overall Mood is generally 0.51% higher than normal after an average of 6.381% recommended daily allowance Iron intake over the previous 7 days. This individual's  data suggests with a high degree of confidence (p=0.069769972931488, 95% CI -0.202 to -0.08) that Iron has a weakly negative predictive relationship (R=-0.14) with Overall Mood. The highest quartile of Overall Mood measurements were observed following an average 6.56% recommended daily allowance Iron. The lowest quartile of Overall Mood measurements were observed following an average 18.290673152219 %RDA Iron.Overall Mood is generally 1.85% lower than normal after an average of 18.290673152219% recommended daily allowance of Iron intake over the previous 7 days. Overall Mood is generally 0.51% higher after an average of 6.56% recommended daily allowance of Iron intake over the previous 7 days. </div>
...
<b>Iron Pre-Processing</b><br>Iron measurement values below 0% recommended daily allowance were assumed erroneous and removed. No maximum allowed measurement value was defined for Iron. It was assumed that any gaps in Iron data were unrecorded 0% recommended daily allowance measurement values. <br><!--Button--><center>
...
<br><b>Data Quantity</b> <br>1766 raw Iron measurements with 523 changes spanning 2109 days from 2013-01-12 to 2018-10-22 were used in this analysis. 13563 raw Overall Mood measurements with 1185 changes spanning 2509 days from 2012-05-06 to 2019-03-19 were used in this analysis. </div>
...
<td class="text-left" style="background: #FFFFFF; padding: 20px; vertical-align: middle; font-weight: 300; font-size: 18px; text-shadow: -1px -1px 1px rgba(0, 0, 0, 0.1); border-right: 1px solid #C1C3D1; text-align: left;">Number of  Paired  Measurements</td>
                <td class="text-left" style="background: #FFFFFF; padding: 20px; vertical-align: middle; font-weight: 300; font-size: 18px; text-shadow: -1px -1px 1px rgba(0, 0, 0, 0.1); border-right: 0px; text-align: left;">1822</td>
                </tr>
<tr style="border-top: 1px solid #C1C3D1; border-bottom-: 1px solid #C1C3D1; color: #666B85; font-size: 16px; font-weight: normal; text-shadow: 0 1px 1px rgba(256, 256, 256, 0.1);">
...
<td class="text-left" style="background: #FFFFFF; padding: 20px; vertical-align: middle; font-weight: 300; font-size: 18px; text-shadow: -1px -1px 1px rgba(0, 0, 0, 0.1); border-right: 1px solid #C1C3D1; text-align: left;">Statistical  Significance</td>
                <td class="text-left" style="background: #FFFFFF; padding: 20px; vertical-align: middle; font-weight: 300; font-size: 18px; text-shadow: -1px -1px 1px rgba(0, 0, 0, 0.1); border-right: 0px; text-align: left;">0.99999997874485</td>
                </tr>
<tr style="border-top: 1px solid #C1C3D1; border-bottom-: 1px solid #C1C3D1; color: #666B85; font-size: 16px; font-weight: normal; text-shadow: 0 1px 1px rgba(256, 256, 256, 0.1);">
